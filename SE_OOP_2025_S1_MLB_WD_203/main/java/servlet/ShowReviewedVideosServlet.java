...
public class ShowReviewedVideosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // Retrieve from uploaded_videos table
            review reviewedVideo = service.getOne(rev);
            
            if (reviewedVideo == null) {
                request.setAttribute("error", "Video not found in reviewed videos");
            } else {
            ...
            e.printStackTrace();
            request.setAttribute("error", "Error retrieving reviewed video");
            forwardToJSP(request, response);
        }
    }
